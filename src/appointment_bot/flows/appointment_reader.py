...
from appointment_bot.flows.appointment_fetch_probe import read_fetch_probe_appointment_snapshot
...
def availability_result_from_snapshot(
    ...
    *,
    ...
    from appointment_bot.flows.appointments import AVAILABLE_TEXTS, UNAVAILABLE_TEXTS
