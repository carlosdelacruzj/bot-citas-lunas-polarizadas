...
from appointment_bot.flows.appointments import APPOINTMENT_PANEL_SCREENSHOT_SELECTORS
from appointment_bot.flows.reservation_captcha_refresh import (
    ensure_reservation_captcha_loaded,
)
from appointment_bot.flows.reservation_controls import CAPTCHA_MEDIA_SELECTOR
